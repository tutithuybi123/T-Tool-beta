...
code = "#!/usr/bin/env python3
    ...
    print(f'''
                    {Color.LG}╔══════════════════════╗
    {Color.LC}╔╦╗{Color.LB} ╔╦╗╔═╗╔═╗╦      {Color.LG}║ {Color.LR}Created: {Color.LY}20/9/2022   {Color.LG}║
    {Color.LC} ║{Color.LB}{Color.LR}───{Color.LB}║ ║ ║║ ║║      {Color.LG}║ {Color.LR}Updated: {Color.LY}20/9/2022   {Color.LG}║
    {Color.LC} ╩{Color.LB}   ╩ ╚═╝╚═╝╩═╝{Color.LG}Beta{Color.LG}║ {Color.LB}Simple but first pj  {Color.LG}║
                    {Color.LG}╚══════════════════════╝
    {Color.LR}[{Color.LG}>     Made with ☕ By Tutithuybi   {Color.LG}<{Color.LR}]''')
    ...
    while True:
        try:
            ...
            if option == '01' or option == '1':
                ...
                subprocess.run(['pkill -f T-Tool.py'], shell=True)
